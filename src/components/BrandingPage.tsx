...
function createOgImageSvgs(): BrandingAsset[] {
  ...
  const ogA = [
    ...
    '  <text x="120" y="430" fill="#5eead4" font-size="25" font-weight="600" font-family="DM Sans, Arial, sans-serif">Solana • Devnet • ZK-ready</text>',
    "</svg>",
  ].join("\n");
  ...
  const ogB = [
    ...
    '  <text x="94" y="388" fill="#cbd5e1" font-size="36" font-weight="500" font-family="DM Sans, Arial, sans-serif">Private payments on Solana</text>',
